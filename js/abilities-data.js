...
const AbilityDescriptions = {
  ...
  "bard spellcasting": "Cast magic using musical performance.\n• Requires musical instrument or ability to sing as prime material component\n• Cast using Cast Magic Action with brief musical notes\n• Roll Musicianship for casting; use Sing to Augment (normal rules)\n• Can only cast if Unburdened (Things < STR) and wearing Light armor or less\n• Touch-range spells can be performed within 20 feet (no contact needed)\n• Spells in memory = INT/6, increasing with Rank per class table",
  "bardic spellcasting": "Cast magic using musical performance.\n• Requires musical instrument or ability to sing as prime material component\n• Cast using Cast Magic Action with brief musical notes\n• Roll Musicianship for casting; use Sing to Augment (normal rules)\n• Can only cast if Unburdened (Things < STR) and wearing Light armor or less\n• Touch-range spells can be performed within 20 feet (no contact needed)\n• Spells in memory = INT/6, increasing with Rank per class table",
  "bardic spellcaster": "Cast magic using musical performance.\n• Requires musical instrument or ability to sing as prime material component\n• Cast using Cast Magic Action with brief musical notes\n• Roll Musicianship for casting; use Sing to Augment (normal rules)\n• Can only cast if Unburdened (Things < STR) and wearing Light armor or less\n• Touch-range spells can be performed within 20 feet (no contact needed)\n• Spells in memory = INT/6, increasing with Rank per class table",
  "bard spellcaster": "Cast magic using musical performance.\n• Requires musical instrument or ability to sing as prime material component\n• Cast using Cast Magic Action with brief musical notes\n• Roll Musicianship for casting; use Sing to Augment (normal rules)\n• Can only cast if Unburdened (Things < STR) and wearing Light armor or less\n• Touch-range spells can be performed within 20 feet (no contact needed)\n• Spells in memory = INT/6, increasing with Rank per class table",
  "berserk rage": "Enter a battle frenzy up to CON/4 times per day, lasting CON rounds. While raging: Damage Modifier +1 step, Endurance +20%, Willpower +20%, Brawn +40%, Evade -20%, cannot use Artful Dodger. When rage ends, gain 1 Fatigue level. Uses reset on Long Rest.",
  ...
  "characteristic increase": "Add +1 to any Characteristic of your choosing. This increase cannot exceed your racial maximums. You may apply this bonus once per Rank, starting at Rank 2.",
  ...
  "cold-blooded": "Khelmar do not need to eat frequently. One meal a week is sufficient to keep them healthy and well fed, and gorging on a large amount of food removes the need to eat for a month. Reflexes become muted at a penalty of –6 to Initiative and the loss of one Combat Action per Round when exposed to temperatures below 60°F. At 40°F and below, khelmar become completely torpid, entering a helpless catatonic state.",
  ...
  "commanding presence": "1x/day per Rank, it's 2 Grades easier to Influence or Insight allies in combat.",
  "commander": "Allies within 30' gain +5% to attack rolls while you are conscious.",
  "counter song": "Counter sound-based magical effects through performance.\n• Cost: 1 Magic Point and 1 Action Point\n• Roll: Sing or Musicianship as Opposed Roll against the source\n• Effect: Allies within 30 feet are immune to audible enchantments\n• Examples: Siren's song, harpy's scream\n• Duration: 1 minute per Rank\n• The effect can be maintained",
  ...
  "devilish appearance": "Abyssari have unique physical traits that reflect their pedigree. These are purely aesthetic and do not affect play mechanics.",
  ...
  "gifted": "Gain one extra Experience Roll beyond what CHA provides. Humans are naturally versatile.",
  ...
  "inspire competence": "Inspire companions within 30 feet who can hear your performance.\n• Cost: 1 Magic Point\n• Roll: Influence, Oratory, Musicianship, or Sing\n• Effect: Allies gain +10% bonus to all skill rolls\n• Duration: Up to 5 Rounds (GM decides which skills benefit)\n• Takes many forms: heroic tales, tragic poems, haunting tunes, or battle encouragement",
  "inspire courage": "Stir up bravery in all allies within 30 feet (including yourself).\n• Grants +5% bonus to Combat Skill\n• Grants +5% to all Resistance Rolls against Charm and Fear effects\n• Takes effect immediately\n• Lasts while performing, plus up to 5 Rounds per Rank after finishing\n• No minimum performance time required\n• May stop any time after first Turn",
  "inspire courage 1": "Stir up bravery in all allies within 30 feet (including yourself).\n• Grants +5% bonus to Combat Skill\n• Grants +5% to all Resistance Rolls against Charm and Fear effects\n• Takes effect immediately\n• Lasts while performing, plus up to 5 Rounds per Rank after finishing\n• No minimum performance time required\n• May stop any time after first Turn",
  "inspire courage 2": "As Inspire Courage I, with improvements:\n• Grants +10% bonus to Combat Skill\n• Grants +10% to Resistance Rolls against Charm and Fear effects\n• Effects last +2 Rounds longer\n• Requires Musicianship and Willpower 100% or higher",
  "inspire courage 3": "As Inspire Courage I, with improvements:\n• Grants +15% bonus to Combat Skill\n• Grants +15% to Resistance Rolls against Charm and Fear effects\n• Effects last +3 Rounds longer\n• Requires Musicianship and Willpower 120% or higher",
  "inspire courage ii": "As Inspire Courage I, with improvements:\n• Grants +10% bonus to Combat Skill\n• Grants +10% to Resistance Rolls against Charm and Fear effects\n• Effects last +2 Rounds longer\n• Requires Musicianship and Willpower 100% or higher",
  "inspire courage iii": "As Inspire Courage I, with improvements:\n• Grants +15% bonus to Combat Skill\n• Grants +15% to Resistance Rolls against Charm and Fear effects\n• Effects last +3 Rounds longer\n• Requires Musicianship and Willpower 120% or higher",
  "inspire greatness": "Inspire greatness in allies within 30 feet (including yourself).\n• Cost: 3 Magic Points\n• Targets: 2 allies (+2 additional allies per Rank beyond 3)\n• Roll: Influence, Oratory, Musicianship, or Sing\n• Effect: +10% to all skill and Resistance Rolls\n• Bonus: Damage from first attack is halved\n• Duration: While performing, plus up to 5 Rounds per Rank after\n• Requires: Musicianship and Willpower 90% or higher",
  "inspire heroics": "Inspire heroics in yourself or allies within 30 feet.\n• Cost: 3 Magic Points\n• Targets: Yourself or 1 ally (+2 allies at Rank 5)\n• Roll: Influence, Oratory, Musicianship, or Sing\n• Effect: +20% bonus to all Resistance Rolls, Evade, and Parry\n• Duration: While performing, plus up to 5 Rounds per Rank after\n• Requires: Musicianship and Willpower 110% or higher",
  ...
  "lucky": "Gain one extra Luck Point beyond what POW provides. Humans are naturally fortunate.",
  "magic resistance": "Highly resistant to Arcane magic; Willpower Checks are 1 Difficulty Grade easier when used to resist. This Resistance has no effect on Divine magic. (Dwarves, Halflings, Syrin)",
  "magic resistance (abyssari)": "Due to their devilish ancestry, abyssari can resist Divine magic, their Willpower Checks being 1 Difficulty Grade easier when resisting. This Resistance applies to all Divine magic items, including wands, staves, rods, rings, amulets, potions, horns, and jewels. Only magic weapons such as shields, armor, gauntlets, and girdles can be used without restriction, as can all Arcane magic items.",
  "magic resistance (gnome)": "Like dwarves, gnomes are highly resistant to Arcane magic; Willpower Checks are 1 Difficulty Grade easier when used to resist, 2 grades easier with regards to illusions. This Resistance has no effect on Divine magic. Many gnomes that become mages specialize in the School of Illusion.",
  ...
  "mass suggestion": "Functions as Suggestion ability but affects all subjects currently Fascinated. Requires Musicianship and Willpower 120% or higher.",
  ...
  "shell parry": "When threatened and unable to continue blocking, the khelmar can pull themselves into their shell with an Action Point. This renders them safe from attack (providing the strike does no more than 8 damage) but makes them go Prone when pulling all limbs inside. Coming out of their shell costs an Action Point, and an additional Action Point to stand. Khelmar may substitute Acrobatics when defending, pulling a limb or their head inside the shell. However, doing so with a leg flipper will cause them to go prone.",
  ...
  "song of freedom": "Use Musicianship or Sing to break an Enchantment or Charm on a friend within 30 feet. Requires 1-minute performance. On Success, spend 3 Magic Points and produce Intensity equal to 1/10th of performance skill to overcome the enchantment's Intensity. On Failure, still spend 1 MP. Cannot use on yourself. Requires Musicianship and Willpower 100% or higher.",
  ...
  "suggestion": "Implant a Suggestion (as per spell) in one subject currently Fascinated. Costs 1 additional Magic Point and grants subject a Resistance Roll. If woven into performance, 1 Grade more Difficult to resist. Subjects who resist remain entranced but cannot be targeted again. Requires Musicianship and Willpower 70% or higher.",
  ...
  "swimmer": "Khelmar automatically succeed in every move and maneuver while swimming, and do not need to roll their Swim skill unless attempting an unusually difficult task, such as swimming against a powerful tide or leaping up a waterfall. They may substitute the Swim skill for Athletics and Evade rolls while in water.",
  ...
  "fascinate": "Attempt to enthrall sapient beings within 30 feet who are listening to your speech, song, or music.\n• Affects 1d3+Rank targets (closest first; cannot select individuals)\n• Duration: Up to 5 Rounds per Rank while performing\n• Friends and allies are immune\n• Requires Opposed Test: Oratory, Sing, or Musicianship vs. Willpower\n• Distracted targets resist 1 Grade easier\n• Automatically fails during combat\n• Those who resist are aware of the attempt\n• Ends if target is attacked or disrupted by loud noise\n• Cannot use on same creature more than once per 24 hours",
  "inspire courage i": "Stir up bravery in all allies within 30 feet (including yourself).\n• Grants +5% bonus to Combat Skill\n• Grants +5% to all Resistance Rolls against Charm and Fear effects\n• Takes effect immediately\n• Lasts while performing, plus up to 5 Rounds per Rank after finishing\n• No minimum performance time required\n• May stop any time after first Turn",
